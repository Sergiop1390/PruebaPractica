...
<html>
    <head>
        ...
        <script src="../js/UpdateTienda.js"></script>
        <title></title>
    </head>
    <body>
       ...
       <form <!-- method="POST" action="../Controller/TiendaController.php"-->>
            ...
            <div class="form-group row justify-content-center">
                ...
                <div class="col-sm-5">
                    ...
                    <input type="text" class="form-control" id="num" name="num" value="3" hidden="">
                </div>
            </div>
            <div class="form-group row justify-content-center">
            ...
            <div class="form-group row justify-content-center">
                <div class="col-sm-2">
                    <input type="button" class="btn btn-primary" id="Actualizar_tienda" value="Enviar">
                </div>
            </div>
        </form>
    </body>
